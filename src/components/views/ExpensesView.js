...
export default function ExpensesView() {
	...
	const updateUsedCustomExpense = (expense, newUsedValue) => {
		...
		context.setCustomExpenses([
			...context.customExpenses.filter((exp) => exp.name !== expense),
			{ ...targetExp, used: newUsedValue }
		]);
	};
	...
	context.customExpenses.forEach((exp) => {
		CustomExpenses.push(
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2 border-2 border-indigo-600">
				...
				{inEdit !== exp.name ? (
					<span className="flex">
						Used: {formatter.format(exp.used)}{" "}
						<img
							onClick={() => setInEdit(exp.name)}
							className="ml-1"
							alt="E"
							src={router.basePath + "/images/icons8-pencil-64.png"}
							height="16"
							width="16"
						/>
					</span>
					...
					<UsedExpenseForm
						...
						onSubmit={(newUsed) => {
							setInEdit("");
							updateUsedCustomExpense(exp.name, newUsed);
						}}
					/>
				)}
		...
		<div className="flex flex-row flex-wrap p-7">
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2">
				<h5 className="text-lg font-semibold">
					...
					<span
						className={
							context.expenses.transportation.used > context.expenses.transportation.budget
								? "text-red-600"
								: ""
						}
					>
				...
				{inEdit !== "transportation" ? (
					<span className="flex">
						Used: {processedValues.myExpenses.transportation.used}{" "}
						<img
							onClick={() => setInEdit("transportation")}
							className="ml-1"
							alt="E"
							src={router.basePath + "/images/icons8-pencil-64.png"}
							height="16"
					...
					<UsedExpenseForm
						value={context.expenses.transportation.used}
						onSubmit={(newUsed) => {
							setInEdit("");
							updateUsedExpense("transportation", newUsed);
						}}
					/>
				)}
			...
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2">
				<h5 className="text-lg font-semibold">
					...
					<span
						className={
							context.expenses.housing.used > context.expenses.housing.budget ? "text-red-600" : ""
						}
					>
				...
				{inEdit !== "housing" ? (
					<span className="flex">
						Used: {processedValues.myExpenses.housing.used}{" "}
						<img
							onClick={() => setInEdit("housing")}
							className="ml-1"
							alt="E"
							src={router.basePath + "/images/icons8-pencil-64.png"}
							height="16"
					...
					<UsedExpenseForm
						value={context.expenses.housing.used}
						onSubmit={(newUsed) => {
							setInEdit("");
							updateUsedExpense("housing", newUsed);
						}}
					/>
				)}
			...
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2">
				<h5 className="text-lg font-semibold">
					...
					<span
						className={
							context.expenses.food.used > context.expenses.food.budget ? "text-red-600" : ""
						}
					>
				...
				{inEdit !== "food" ? (
					<span className="flex">
						Used: {processedValues.myExpenses.food.used}{" "}
						<img
							onClick={() => setInEdit("food")}
							className="ml-1"
							alt="E"
							src={router.basePath + "/images/icons8-pencil-64.png"}
							height="16"
					...
					<UsedExpenseForm
						value={context.expenses.food.used}
						onSubmit={(newUsed) => {
							setInEdit("");
							updateUsedExpense("food", newUsed);
						}}
					/>
				)}
			...
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2">
				<h5 className="text-lg font-semibold">
					...
					<span
						className={
							context.expenses.amenities.used > context.expenses.amenities.budget
								? "text-red-600"
								: ""
						}
					>
				...
				{inEdit !== "amenities" ? (
					<span className="flex">
						Used: {processedValues.myExpenses.amenities.used}{" "}
						<img
							onClick={() => setInEdit("amenities")}
							className="ml-1"
							alt="E"
							src={router.basePath + "/images/icons8-pencil-64.png"}
							height="16"
					...
					<UsedExpenseForm
						value={context.expenses.amenities.used}
						onSubmit={(newUsed) => {
							setInEdit("");
							updateUsedExpense("amenities", newUsed);
						}}
					/>
				)}
			...
			{CustomExpenses}
			<div className="flex flex-col bg-green-300 rounded-md p-2 m-2">
				<h5 className="text-lg text-blue-500 font-semibold">+ Add Expense</h5>
